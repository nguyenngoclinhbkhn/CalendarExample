...
public class WeekViewVer2 extends View {
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX, float distanceY) {
            ...
            switch (mCurrentScrollDirection) {
                ...
                case RIGHT:
                    ...
                    ViewCompat.postInvalidateOnAnimation(WeekViewVer2.this);
                    break;
                case VERTICAL:
    ...
    public WeekViewVer2(Context context) {
        this(context, null);
    }

    public WeekViewVer2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WeekViewVer2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mEventRects != null && mEventRects.size() > 0) {
            for (int dayNumber = 0;
                ...
                for (int i = 0; i < mEventRects.size(); i++) {
                    ...
                    if (WeekViewUtils.isSameDay(mEventRects.get(i).event.getStartTime(), day) && mEventRects.get(i).event.isAllDay()) {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        Calendar today = WeekViewUtils.today();
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            boolean sameDay = WeekViewUtils.isSameDay(day, today);
    ...
    private void drawEvents(Calendar date, float startFromPixel, Canvas canvas) {
        if (mEventRects != null && mEventRects.size() > 0) {
            for (int i = 0; i < mEventRects.size(); i++) {
                if (WeekViewUtils.isSameDay(mEventRects.get(i).event.getStartTime(), date) && !mEventRects.get(i).event.isAllDay()) {
    ...
    private void getMoreEvents(Calendar day) {
        ...
        while (tempEvents.size() > 0) {
            ...
            while (i < tempEvents.size()) {
                ...
                if (WeekViewUtils.isSameDay(eventRect1.event.getStartTime(), eventRect2.event.getStartTime())) {
                    tempEvents.remove(i);
